...
class CDIFactoryDefault extends CDI
{
   /**
    ...
    public function __construct()
    {
        ...
        $this->setShared('informer', function () {
            $informer = new \Anax\Informer\Informer();
            $informer->setDI($this);
            return $informer;
        });
        ...
        $this->set('FormController', function () {
            $form = new \Anax\HTMLForm\FormController();
            $form->setDI($this);
            return $form;
        });
        ...
        $this->set('QuestionsController', function() {
            $user = new \Anax\Questions\QuestionsController();
            $user->setDI($this);
            return $user;
        });

        $this->set('TagsController', function() {
            $tag = new \Anax\Tags\TagsController();
            $tag->setDI($this);
            return $tag;
        });
